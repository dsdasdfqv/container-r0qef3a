...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-r0qef3a.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-r0qef3a.containers.anotherwebservice.com/
...
```
git clone git@github.com:dsdasdfqv/container-r0qef3a.git
cd container-r0qef3a
```
...
```
docker attach container-r0qef3a
```
